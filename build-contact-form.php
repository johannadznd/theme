...
function lgmac_contact_create_menu(){
    add_menu_page( 'messages', 'Messages', 'edit_pages', 'messages_reçus' , 'lgmac_create_page_contact', 'dashicons-email-alt',6);
}
...
<style>
    ...
    <div style="margin-top:40px;">
            <div>
                <h1 style="text-align: center;">Liste des messages reçus</h1>
